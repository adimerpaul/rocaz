...
</html>`,document.getElementById("myElement").innerHTML=c,new S().print(document.getElementById("myElement")),e(d)}).catch(d=>{r(d)})})}static nota(t){return console.log("factura",t),new Promise((e,r)=>{const o=x.conversorNumerosALetras,s=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},a=D().env;F.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,l).then(d=>{let c=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
</html>`,document.getElementById("myElement").innerHTML=c,new S().print(document.getElementById("myElement")),e(d)}).catch(d=>{r(d)})})}static cotizacion(t,e,r,o){return console.log("detalle",t),console.log("cliente",e),console.log("total",r),console.log("descuento",o),(o==null||o==="")&&(o=0),new Promise((i,s)=>{const l=x.conversorNumerosALetras,d=new l().convertToText(parseInt(r)),c=Vt().format("YYYY-MM-DD"),E={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},u=D().env;F.toDataURL(`Fecha: ${c} Monto: ${parseFloat(r).toFixed(2)}`,E).then(h=>{let f=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
  <img src="logo.png" alt="logo" style="width: 100px; height: 50px; display: block; margin-left: auto; margin-right: auto;">
...
<tr><td class='titder'>FECHA DE EMISI\xD3N:</td><td class='contenido'>${c}</td></tr>
</table><hr><div class='titulo'>DETALLE</div>`;t.forEach(C=>{f+=`<div style='font-size: 12px'><b> ${C.nombre} </b></div>`,f+=`<div><span style='font-size: 18px;font-weight: bold'>${C.cantidadVenta}</span> ${parseFloat(C.precioVenta).toFixed(2)} 0.00
                    <span style='float:right'>${parseFloat(C.precioVenta*C.cantidadVenta).toFixed(2)}</span></div>`}),f+=`<hr>
...
</html>`,document.getElementById("myElement").innerHTML=f,new S().print(document.getElementById("myElement")),i(h)}).catch(h=>{s(h)})})}static notaCompra(t){return console.log("factura",t),new Promise((e,r)=>{const o=x.conversorNumerosALetras,s=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},a=D().env;F.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,l).then(async d=>{let c=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
  <img src="logo.png" alt="logo" style="width: 100px; height: 50px; display: block; margin-left: auto; margin-right: auto;">
...
</html>`,document.getElementById("myElement").innerHTML=c,new S().print(document.getElementById("myElement")),e(d)}).catch(d=>{r(d)})})}static reportTotal(t,e){const r=t.filter(s=>s.tipoVenta==="Ingreso").reduce((s,l)=>s+l.montoTotal,0),o=t.filter(s=>s.tipoVenta==="Egreso").reduce((s,l)=>s+l.montoTotal,0),i=r-o;return console.log("montoTotal",i),new Promise((s,l)=>{const a=x.conversorNumerosALetras,d=new a,c=Math.abs(i),E=d.convertToText(parseInt(c)),u={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},h=D().env;F.toDataURL(` Monto: ${parseFloat(i).toFixed(2)}`,u).then(f=>{let y=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
<hr>
<table>
</table><hr><div class='titulo'>DETALLE</div>`;t.forEach(g=>{y+=`<div style='font-size: 12px'><b> ${g.user.name} </b></div>`,y+=`<div> ${parseFloat(g.montoTotal).toFixed(2)} ${g.tipoVenta}
          <span style='float:right'> ${g.tipoVenta==="Egreso"?"-":""} ${parseFloat(g.montoTotal).toFixed(2)}</span></div>`}),y+=`<hr>
      <table style='font-size: 8px;'>
...
</html>`,document.getElementById("myElement").innerHTML=y,new S().print(document.getElementById("myElement")),s(f)}).catch(f=>{l(f)})})}static reciboCompra(t){return new Promise((e,r)=>{const o=x.conversorNumerosALetras,s=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},a=D().env;F.toDataURL(`Fecha: ${t.date} Monto: ${parseFloat(t.total).toFixed(2)}`,l).then(d=>{let c=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
    ...
    </html>`,document.getElementById("myElement").innerHTML=c,new S().print(document.getElementById("myElement")),e(d)}).catch(d=>{r(d)})})}static reciboTranferencia(t,e,r,o){return console.log("producto",t,"de",e,"ha",r,"cantidad",o),new Promise((i,s)=>{const l=x.conversorNumerosALetras,d=new l().convertToText(parseInt(o)),c={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},E=D().env;F.toDataURL(`de: ${e} A: ${r}`,c).then(u=>{let h=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
