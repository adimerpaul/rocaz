...
</html>`,document.getElementById("myElement").innerHTML=c,new S().print(document.getElementById("myElement")),e(u)}).catch(u=>{i(u)})})}static nota(t,e=!0){return new Promise((i,o)=>{const r=x.conversorNumerosALetras,l=new r().convertToText(parseInt(t.total-t.descuento)),a={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},u=D().env;F.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,a).then(c=>{let m=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
