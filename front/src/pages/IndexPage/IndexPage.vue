  ...
  <q-page class="q-pa-xs bg-grey-3">
    <div class="row">
      ...
      <div class="col-12 col-md-3 q-pa-xs">
        <q-input v-model="concepto" label="Buscar por concepto" dense outlined class="bg-white">
      ...
      <div class="col-12 col-md-4 q-pa-xs">
        <CardComponent :monto="1000" color="grey" title="Balance" icono="o_trending_up" />
      </div>
      <div class="col-12 col-md-4 q-pa-xs">
        <CardComponent :monto="1000" color="green" title="Ventas" icono="o_trending_up" />
      </div>
      <div class="col-12 col-md-4 q-pa-xs">
        <CardComponent :monto="1000" color="red" title="Gastos" icono="o_trending_down" />
      </div>
      <div class="col-12">
